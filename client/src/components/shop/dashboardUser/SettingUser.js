          ...
          <div className="py-4 px-4 md:px-8 lg:px-16 flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input
                ...
                className="border px-4 py-2 w-full focus:outline-none"
              />
              {!validatePassword(fData.newPassword) && fData.newPassword && (
                <div className="text-red-500 text-sm">
                  Password must be 8-12 characters long and include uppercase, lowercase, numbers, and symbols.
                </div>
              )}
            </div>
            <div className="flex flex-col space-y-2">
              ...
              <input
                ...
                className="border px-4 py-2 w-full focus:outline-none"
              />
              {fData.newPassword && fData.newPassword !== fData.confirmPassword && (
                <div className="text-red-500 text-sm">Passwords do not match</div>
              )}
            </div>
            <div
              onClick={() => handleChangePassword(fData, setFdata, dispatch)}
              style={{ background: "#303031" }}
              className="w-full text-center cursor-pointer px-4 py-2 text-gray-100"
            >
              Change Password
